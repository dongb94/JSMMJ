...
public class GoogleAdMob
{
    ...
    private const string InterstitialAdID = "ca-app-pub-9424990989289285/4796939379";// 전면 광고 ID
    private const string BannerAdID = "ca-app-pub-9424990989289285/3675429399"; // 베너 광고 ID
    private const string RewardedAdID = ""; // 보상형 광고 ID
    ...
    private void LoadBannerAd()
    {
        ...
        _bannerView = new BannerView(_unitID, AdSize.Banner, AdPosition.Bottom);
